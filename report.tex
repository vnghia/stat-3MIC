...
{\centering \includegraphics{report_files/figure-latex/daf-acousticness-boxplot-1} 
...
{\centering \includegraphics{report_files/figure-latex/corr-dafacp-1} 
...
{\centering \subfloat[le plan des axes principaux 1 et 2\label{fig:projection-pop-12-13-1}]{\includegraphics[width=0.5\linewidth,height=0.5\textheight]{report_files/figure-latex/projection-pop-12-13-1} }\subfloat[le plan des axes principaux 1 et 3\label{fig:projection-pop-12-13-2}]{\includegraphics[width=0.5\linewidth,height=0.5\textheight]{report_files/figure-latex/projection-pop-12-13-2} }
...
{\centering \subfloat[les dimensions 1 et 2\label{fig:corvar-acp-12-13-1}]{\includegraphics[width=0.5\linewidth]{report_files/figure-latex/corvar-acp-12-13-1} }\subfloat[les dimensions 1 et 3\label{fig:corvar-acp-12-13-2}]{\includegraphics[width=0.5\linewidth]{report_files/figure-latex/corvar-acp-12-13-2} }
