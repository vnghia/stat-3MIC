...
\FunctionTok{print}\NormalTok{(}\FunctionTok{label\_percent}\NormalTok{()(}\FunctionTok{c}\NormalTok{(pop\_class\_table) }\SpecialCharTok{/} \FunctionTok{sum}\NormalTok{(pop\_class\_table)), }\AttributeTok{quote =} \ConstantTok{FALSE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
